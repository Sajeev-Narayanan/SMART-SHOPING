...
public class sendcomplaint extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edcomplaint=(EditText)findViewById(R.id.editText17);
        btsubmit=(Button)findViewById(R.id.button5);
    ...
    public void onClick(View view) {
        ...
        final String comp=edcomplaint.getText().toString();
        SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String hu = sh.getString("ip", "");
        String url = "http://" + hu + ":5005/send_complaint";
